...
<model-viewer id="reveal" loading="eager" camera-controls autoplay animation-name="Take 01" src="Models/YellowSubmarine/scene.gltf" ar="" ar-modes="scene-viewer webxr quick-look" ios-src="Yellow_submarine_-_Beatles.usdz" alt="Yellow-Submarine" auto-rotate="" auto-rotate-delay="0" ar-scale="auto" camera-controls=""  style="width: 95%; height: 500px" exposure="0.5"> <button slot="ar-button" style="background-color: white; border-radius: 8px; border: 1 px solid black; position: absolute; top: 20px; right: 20px; ">
      👋 AR Click Here
  </button>
</model-viewer>
